...
| ~~Prestige-Punkteformel gegen die Wellenkurve~~ | **erledigt** — gemessen, und der Befund war ein anderer als notiert: Mit Goldanteil trifft die Formel vier der fünf GDD-Zeilen (6 / 132 / 511 / 2010 / 49558). Die fünfte war **unerfüllbar** — die drei mittleren Richtwerte vertragen sich mit keinem Potenzgesetz. Korrigiert wurde die Tabelle in GDD 10 §5, gesichert durch `prestigePointsRule` in `src/selftest/guards.ts`, die beide Seiten gegeneinander hält |
| ~~Prestige-Baum gegen die Punkteausbeute~~ | **erledigt.** Nachgerechnet lag der Fehler nicht in der Summe, sondern **oben in den Ketten**: Die vierzehn Knoten, die das GDD gar nicht nennt, wuchsen mit Faktor vier bis fünf und endeten bei 25.000 Punkten — Welle 7.116, während das Spiel bis Welle 1.000 gemessen ist. Sie wachsen jetzt mit Faktor zwei; die sechzehn Kosten, die im GDD stehen, sind unverändert. Summe 21.000 statt 81.550, teuerster Knoten Welle 2.382 statt 7.116. Zwei Tests in `suites/prestige.ts` halten Gefälle und Obergrenze fest |
| **Das erste Prestige zahlt nichts** | **neu, beim Messen gefunden.** Erlaubt ist es ab 200 verdientem Gold — erreicht auf **Welle 9**, und die Formel gibt dort **0 Punkte**. Der billigste Knoten (10, aus dem GDD) verlangt Welle 130. GDD 10 §1: „Prestige soll niemals wie ein Verlust wirken.“ Ein Zurücksetzen für null ist genau das. Der Hebel ist `PRESTIGE_MIN_GOLD` oder die Goldkurve, nicht der Baum — gehört zum Balancing der Wellenkurve |
